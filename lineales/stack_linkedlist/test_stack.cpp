...
TEST_CASE("adding and removing elements from a stack", "StackLinkedList") {
...
TEST_CASE("copy constructor for empty stack", "StackLinkedList") {
  StackLinkedList<int> s1;
...
TEST_CASE("assignment operator for empty stack", "StackLinkedList") {
  StackLinkedList<int> s1;
...
TEST_CASE("copy constructor for nonempty stack", "StackLinkedList") {
  StackLinkedList<int> s1;
  s1.push(1);
  s1.push(2);
  StackLinkedList<int> s2 = s1;
...
TEST_CASE("assignment operator to nonempty stack", "StackLinkedList") {
  StackLinkedList<int> s1;
  s1.push(1);
  s1.push(2);
  StackLinkedList<int> s2;
