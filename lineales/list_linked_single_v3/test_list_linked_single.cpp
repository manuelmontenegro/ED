...
std::string list_to_string(const ListLinkedSingle &l) {
  std::stringstream output;
  l.display(output);
  return output.str();
}

TEST_CASE("addition and removal on lists of strings", "ListLinkedSingle") {
  ListLinkedSingle l;
...
TEST_CASE("update a list of strings", "ListLinkedSingle") {
  ListLinkedSingle l;
  l.push_back("David");
  l.push_back("Elvira");
  l.push_back("Gerardo");
  ...
  SECTION("modify the first element") {
    l.front() = "Lidia";
    REQUIRE ( l.size() == 3 );
    REQUIRE ( l.at(0) == "Lidia" );
    REQUIRE ( l.at(1) == "Elvira" );
    REQUIRE ( l.at(2) == "Gerardo" );
  }

  SECTION("modify the last element") {
    l.back() = "Lidia";
    REQUIRE ( l.size() == 3 );
    REQUIRE ( l.at(0) == "David" );
    REQUIRE ( l.at(1) == "Elvira" );
    REQUIRE ( l.at(2) == "Lidia" );
  }
  ...
  SECTION("modify the element in the middle") {
    ...
    REQUIRE ( l.size() == 3 );
    REQUIRE ( l.at(0) == "David" );
    REQUIRE ( l.at(1) == "Lidia" );
    REQUIRE ( l.at(2) == "Gerardo" );
  }
}

TEST_CASE("creating copies of lists", "ListLinkedSingle") {
  ListLinkedSingle l;
  l.push_back("David");
  l.push_back("Elvira");
  l.push_back("Gerardo");

  ListLinkedSingle l2 = l;

  SECTION("the copy contains the same elements as the original one") {
    REQUIRE ( l2.size() == 3 );
    REQUIRE ( l2.at(0) == "David" );
    REQUIRE ( l2.at(1) == "Elvira" );
    REQUIRE ( l2.at(2) == "Gerardo" );
  }
